...
import dev.rcd2obj.codegen.render.format.rule.JavaElementFormatLineAfterRule;
import dev.rcd2obj.codegen.render.format.rule.JavaElementFormatLineBeforeRule;
import dev.rcd2obj.codegen.render.format.rule.JavaElementFormatRule;
import dev.rcd2obj.codegen.render.format.rule.JavaElementFormatSpaceAfterRule;
import dev.rcd2obj.codegen.render.format.rule.JavaElementFormatSpaceBeforeRule;
import dev.rcd2obj.codegen.render.format.rule.JavaElementIndentBlockFormatRule;
import dev.rcd2obj.codegen.render.format.rule.condition.JavaElementFormatKeywordRuleCondition;
import dev.rcd2obj.codegen.render.format.rule.condition.JavaElementFormatRuleAnyCondition;
import dev.rcd2obj.codegen.render.format.rule.condition.JavaElementFormatRuleIsCondition;
      ...
      new JavaElementFormatSpaceAfterRule(
        new JavaElementFormatRuleConditionAndGroup(
          ...
          new JavaElementFormatRuleIsCondition(
            ...
            JavaElementType.METHOD_DEFINITION_PARAMS_SEPARATOR,
