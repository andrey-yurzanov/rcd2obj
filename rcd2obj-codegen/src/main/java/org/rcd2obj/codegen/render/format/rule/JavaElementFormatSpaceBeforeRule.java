...
import org.rcd2obj.codegen.render.format.rule.condition.group.JavaElementFormatRuleConditionGroup;

/**
 * The formatting rule for append space before element.
 *
 * @author Andrey_Yurzanov
 * @since 1.0
 */
public class JavaElementFormatSpaceBeforeRule implements JavaElementFormatRule {
   ...
   */
  public JavaElementFormatSpaceBeforeRule(JavaElementFormatRuleConditionGroup condition) {
