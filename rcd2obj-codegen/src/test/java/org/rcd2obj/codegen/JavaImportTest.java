...
class JavaImportTest {
  ...
  @Test
  void compareToTest() {
    assertEquals(0, new JavaImport(ArrayList.class).compareTo(new JavaImport(ArrayList.class)));
    assertNotEquals(0, new JavaImport(Integer.class).compareTo(new JavaImport(ArrayList.class)));
  }
