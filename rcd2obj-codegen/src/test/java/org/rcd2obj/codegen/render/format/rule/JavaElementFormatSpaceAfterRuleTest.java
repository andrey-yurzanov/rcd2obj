...
/**
 * Tests of JavaElementFormatSpaceAfterRule.
 *
 * @author Andrey_Yurzanov
 */
class JavaElementFormatSpaceAfterRuleTest {
  private static final String ONE_SPACE_EXPECTED = " ";

  @Test
  void afterTest() {
    JavaElementFormatSpaceAfterRule rule = new JavaElementFormatSpaceAfterRule(
