...
/**
 * Tests of the generic parameter.
 *
 * @author Andrey_Yurzanov
 */
class JavaGenericParameterTest {
  private static final int ORDER = 1;
  private static final String NAME = "T";
  private static final String EXPECTED_WITHOUT_TYPE = "java.lang.Object";
  private static final String EXPECTED_WITH_TYPE = "java.lang.String";

  @Test
  void renderTest() {
    JavaGenericParameter parameter = new JavaGenericParameter()
        .parameterName(NAME)
